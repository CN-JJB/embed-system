...
int acquisition_pipeline_init(uint32_t sysclk_hz)
{
    ...
    /* TODO: Power on ADC1 and execute bounded RSTCAL / CAL sequence */

    /* TODO: Configure ADC1 EXTSEL for TIM3 TRGO, EXTTRIG, and DMA enable */

    /* TODO: Configure TIM3 PSC and ARR for 10 kHz, MMS=010 Update, enable CEN */
    (void)sysclk_hz;

    /* TODO: Configure DMA1 Channel 1: CPAR, CMAR, CNDTR=128, CIRC, MINC, 16-bit, HTIE, TCIE, EN */
...
{
    /* TODO: Read DMA1->ISR, clear HTIF1/TCIF1 in DMA1->IFCR, pulse PA3/PA4, increment counters */
    __DSB();
}
