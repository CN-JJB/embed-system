...
int acquisition_pipeline_init(uint32_t timclk_hz)
{
    ...
    /* MUTATION: CIRC mode omitted (runs once then stops) */
    DMA1_Channel1->CCR = DMA_CCR_MINC | DMA_CCR_PSIZE_0 | DMA_CCR_MSIZE_0 | DMA_CCR_HTIE | DMA_CCR_TCIE | DMA_CCR_TEIE | DMA_CCR_EN;
