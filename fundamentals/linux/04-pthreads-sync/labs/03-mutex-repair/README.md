...
## Objective
Repair the counter with invariant: counter changes only while mutex held.
...
## Procedure
Compare source with Lab 02; repeat runs and TSan separately.

## Expected Observation
Final count is coherent for exercised runs and synchronization expresses the invariant.
