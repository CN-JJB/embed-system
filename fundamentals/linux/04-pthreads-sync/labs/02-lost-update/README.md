...
## Objective
Classify unsynchronized conflicting counter accesses as a data race independent of final output.
...
## Procedure
Run repeatedly, then build with TSan separately if available. Record actual evidence only.

## Expected Observation
Results may vary or even look correct; TSan may report the race on supported runtime.
