...
# P3-M01 Reviewer-Only Full Authoring Regression (REVIEWER-ONLY)
...
echo "##################################################################"
echo "# P3-M01 REVIEWER-CHECK — AUTHORING REGRESSION (REVIEWER-ONLY)  #"
echo "##################################################################"
...
bash reviewer/scripts/generate_m01_challenge_fixtures.sh challenge/fixtures "$CROSS_COMPILE"
bash reviewer/scripts/generate_m01_gate_fixtures.sh gate/fixtures "$CROSS_COMPILE"
echo "[PASS] M01 assessment fixtures materialized under challenge/ and gate/"
...
bash reviewer/test_m01_oracle_mutations.sh

echo ""
echo "=== P3-M01 REVIEWER-CHECK COMPLETE: ALL STAGES PASSED ==="
