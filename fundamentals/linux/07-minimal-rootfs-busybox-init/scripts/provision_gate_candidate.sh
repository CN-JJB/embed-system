...
#   2. the small opaque assignment input gate/fixtures/candidate.layer,
...
LAYER="$M03_ROOT/gate/fixtures/candidate.layer"
...
echo "[PASS] Gate candidate provisioned at: $OUT (verified staging + opaque assignment layer)"
