...
#      challenge/fixtures/defective_overlay/ + challenge/fixtures/defects.manifest.
#
...
FIXTURE_DIR="$M03_ROOT/challenge/fixtures"
...
echo "[PASS] Challenge candidate provisioned at: $OUT (verified staging + small assessment delta)"
