...
echo "  [3] processor-specific setup (e.g. __v7_setup in proc-v7.S: TTBCR/TTBR preparation)"
echo "  [4] MMU enable transition: __enable_mmu loads DACR (CP15 c3) + TTBR0 (CP15 c2),"
echo "      __turn_mmu_on writes SCTLR and issues instr_sync (see pinned head.S/proc-v7.S)"
