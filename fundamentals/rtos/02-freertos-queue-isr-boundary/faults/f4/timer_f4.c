...
void TIM2_IRQHandler(void)
{
    if ((TIM2->SR & TIM_SR_UIF) != 0) {
        ...
        /* Preemption defect: portYIELD_FROM_ISR(xHigherPriorityTaskWoken) omitted!
         * Even though Task_Consumer (prio 3) is moved to Ready list, PendSV is not pended.
         * The task will not run until the next SysTick interrupt forces a context switch.
         */
