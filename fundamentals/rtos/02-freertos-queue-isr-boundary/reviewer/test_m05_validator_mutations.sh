#!/usr/bin/env bash
# ==============================================================================
# test_m05_validator_mutations.sh: Positive & Negative Regression Suite
# ==============================================================================
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
M05_DIR="$(cd "${SCRIPT_DIR}/.." && pwd)"
VALIDATE_SH="${M05_DIR}/challenge/validate.sh"
REF_DIR="${SCRIPT_DIR}/challenge-reference"
MUTATIONS_DIR="${SCRIPT_DIR}/mutations"

echo "=== Running P2-M05 Challenge Validator Regression Suite ==="
...
echo "=== ALL P2-M05 POSITIVE AND NEGATIVE VALIDATOR CHECKS PASSED ==="
