/* Mutation m8: Missing stack high-water mark tracking */
#include "app_tasks.h"
#include <stddef.h>
...
static void vTelemetryTask(void *pvParameters)
{
    ...
    for (;;) {
        ...
        /* MUTATION m8: High-water mark not queried; left at 0 */
        taskENTER_CRITICAL();
        g_telemetry.telemetry_cycles++;
        g_telemetry.telemetry_high_water_words = 0;
        g_telemetry.worker_high_water_words = 0;
