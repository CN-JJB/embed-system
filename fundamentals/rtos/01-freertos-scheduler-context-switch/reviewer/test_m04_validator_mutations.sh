#!/usr/bin/env bash
# ==============================================================================
# test_m04_validator_mutations.sh: Regression suite testing validator against mutations
# ==============================================================================
set -euo pipefail
...
echo "=== Running P2-M04 Challenge Validator Negative Mutation Suite ==="

PASS_COUNT=0
FAIL_COUNT=0

for mut in "${MUTATIONS_DIR}"/m*.c; do
    if [ -f "${mut}" ]; then
...
echo "=== ALL P2-M04 VALIDATOR MUTATIONS REJECTED SUCCESSFULLY ==="
