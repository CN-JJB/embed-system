...
static void prvTaskLow(void *pvParameters)
{
    ...
    for (;;) {
        ...
        /* Step 5: FAULT f3: Low voluntarily yields via vTaskDelay inside the critical section!
         * Even with priority inheritance, yielding puts Low into the Blocked state,
         * allowing Medium (priority 2) to preempt and introduce 20 ms delay.
         */
